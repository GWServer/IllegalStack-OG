...
public class SpigotMethods {
    ...
    public static BaseComponent makeParentText(Protections protections, String status, boolean children, int catId) {
        ...
        if (!protections.isList()) {
            ...
            cLink.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT,
            ...
            if (!protections.getTxtSet().isEmpty()) {
                ...
                opt.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT,
        ...
        if (!protections.getDescription().equalsIgnoreCase("")) {
            ...
            String desc = protections.getDescription() + ChatColor.AQUA + " " + protections.getVersion()
                    + ChatColor.RESET;
        ...
        if (children) {
            ...
            opt.setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND,
    ...
    public static BaseComponent makeChildText(Protections p, int catId) {
        ...
        if (p.isList()) {
            ...
            TextComponent option = new TextComponent(
                    ChatColor.GRAY + " [" + ChatColor.GREEN + "TXT" + ChatColor.GRAY + "] ");
            option.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new Text(p.findValue())));
            option.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT,
