...
public class NBTApiStuff {
    ...
    public static int isBadShulkerLegacy(ItemStack is) {
        /*
         * NBTItem nbti2 = new NBTItem(is); for(String key:nbti2.getKeys()) {
         * 
         * NBTCompoundList nbtList = nbti2.getCompoundList(key);
         * 
         * if(nbti2.getType(key) == NBTType.NBTTagList) { NBTTagList nestedList =
         * nbti2.getObject(key, NBTTagList.class); if(nestedList != null) {
         * 
         * } else { nbti2.removeKey(key); } } }
         */
    ...
    public static boolean checkForBadCustomDataLegacy(ItemStack is, Object obj) {
        ...
        if (itemTag.size() > 0) {
            ...
            fListener.getLog().append(Msg.CustomAttribsRemoved3.getValue(is, obj, attribs),
