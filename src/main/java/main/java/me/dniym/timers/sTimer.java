...
public class sTimer implements Runnable {
    ...
    public void run() {
        ...
        if (!Protections.DestroyBadSignsonChunkLoad.isEnabled()
                || Protections.DestroyBadSignsonChunkLoad.notifyOnly())
        {
                    ...
                    if (st instanceof Sign) {
                        ...
                        for (String line : sign.getLines()) {
                                    ...
                                    .canEncode(ChatColor.stripColor(line)))
                            {
                                ...
                                illegal = true;
                                LOGGER.info("Found a sign with illegal chars: line with invalid text was: {} @ {}",
                                        line, sign.getLocation().toString());
                        ...
                        if (illegal) {
                            ...
                            if (p != null) {
                                ...
                                fListener.getLog().append2(Msg.SignRemovedOnPlace.getValue(sign.getLocation(),
