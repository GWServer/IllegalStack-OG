...
public class IllegalStackAction {
    ...
    public static boolean isCompleted(Protections protection, Entity cause, Block block, ItemStack itemInHand,
            Entity mount, Inventory inventory)
    {

        IllegalStackActionEvent event = new IllegalStackActionEvent(protection, cause, block, itemInHand, mount,
                inventory);
